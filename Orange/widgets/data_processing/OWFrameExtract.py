...
class OWFrameExtract(SingleInputWidget):
    name = "FrameExtract"
    description = ("Extract Frames from video paths.")
    icon = "icons/extract_column.svg"
...
#    num_worker = Setting(1)
#    semantic_types_buf = Setting(('https://metadata.datadrivendiscovery.org/types/TrueTarget',))
...
if __name__ == "__main__":
    WidgetPreview(OWFrameExtract).run(Orange.data.Table("iris"))
