...
#from autovideo.recognition import *
#from autovideo.recognition.eco_full_primitive import *
class OWECO_full(TODS_BaseWidget):
    name = "ECO_full"
    description = ("Action Recognoition with ECO_full model")
    icon = "icons/ECO_full.svg"
...
#    # set default hyperparameters here
    ...
    def __init__(self):
        ...
        self.python_path = 'd3m.primitives.autovideo.recognition.eco_full'
...
if __name__ == "__main__":
    WidgetPreview(OWECO_full).run(Orange.data.Table("iris"))
