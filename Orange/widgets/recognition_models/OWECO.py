...
class OWECO(TODS_BaseWidget):
    name = "ECO"
    description = ("Action Recognoition with ECO model")
    icon = "icons/ECO.svg"
...
#    # set default hyperparameters here
    ...
    def __init__(self):
        ...
        self.python_path = 'd3m.primitives.autovideo.recognition.eco'
...
if __name__ == "__main__":
    WidgetPreview(OWECO).run(Orange.data.Table("iris"))
