...
class OWCOF(SingleInputWidget):
    ...
    def _init_ui(self):
        ...
        gui.comboBox(box, self, "pretrained", sendSelectedValue=True, label='Pretrained.', items=[True, False], )
    ...
    def _print_hyperparameter(self):
        ...
        print(self.pretrained, type(self.pretrained))
