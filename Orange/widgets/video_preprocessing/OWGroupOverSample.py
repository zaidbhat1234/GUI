...
from tods.feature_analysis.StatisticalMeanAbsTemporalDerivative import *

class OWGroupOverSample(SingleInputWidget):
    name = "GroupOverSample"
    description = ("OWGroupOverSample.")
    icon = "icons/MeanAbsTemporalDerivative.svg"
    ...
    primitive = StatisticalMeanAbsTemporalDerivativePrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWGroupOverSample).run(Orange.data.Table("iris"))
