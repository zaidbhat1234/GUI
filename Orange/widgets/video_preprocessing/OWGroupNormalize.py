...
from tods.feature_analysis.StatisticalAbsSum import *

class OWGroupNormalize(SingleInputWidget):
    name = "GroupNormalize"
    description = ("OWGroupNormalize.")
    icon = "icons/DCT.svg"
    ...
    primitive = StatisticalAbsSumPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWGroupNormalize).run(Orange.data.Table("iris"))
