...
from tods.feature_analysis.StatisticalAbsEnergy import *

class OWGroupRandomHorizontalFlip(SingleInputWidget):
    name = "GroupRandomHorizontalFlip"
    description = ("OWGroupRandomHorizontalFlip.")
    ...
    primitive = StatisticalAbsEnergyPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWGroupRandomHorizontalFlip).run(Orange.data.Table("iris"))
