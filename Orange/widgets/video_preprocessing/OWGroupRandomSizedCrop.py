...
from tods.feature_analysis.StatisticalVecSum import *

class OWGroupRandomSizedCrop(SingleInputWidget):
    name = "GroupRandomSizedCrop"
    description = ("OWGroupRandomSizedCrops.")
    ...
    primitive = StatisticalVecSumPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWGroupRandomSizedCrop).run(Orange.data.Table("iris"))
