...
from tods.feature_analysis.StatisticalZeroCrossing import *

class OWStack(SingleInputWidget):
    name = "Stack"
    description = ("OWStack.")
    icon = "icons/NMF.svg"
    ...
    primitive = StatisticalZeroCrossingPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWStack).run(Orange.data.Table("iris"))
