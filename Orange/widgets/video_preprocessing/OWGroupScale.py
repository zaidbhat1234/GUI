...
from tods.feature_analysis.StatisticalMeanAbs import *

class OWGroupScale(SingleInputWidget):
    name = "GroupScale"
    description = ("OWGroupScale.")
    icon = "icons/AbsMean.svg"
    ...
    primitive = StatisticalMeanAbsPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWGroupScale).run(Orange.data.Table("iris"))
