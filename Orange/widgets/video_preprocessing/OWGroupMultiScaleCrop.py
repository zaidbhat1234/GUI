...
from tods.feature_analysis.StatisticalVar import *

class OWGroupMultiScaleCrop(SingleInputWidget):
    name = "GroupMultiScaleCrop"
    description = ("OWGroupMultiScaleCrop.")
    ...
    primitive = StatisticalVarPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWGroupMultiScaleCrop).run(Orange.data.Table("iris"))
