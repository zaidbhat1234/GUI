...
class CenterCropToFixedSize(SingleInputWidget):
    name = "CenterCropToFixedSize"
    description = ("Computes CenterCropToFixedSize")
    icon = "icons/56.svg"
...
if __name__ == "__main__":
    WidgetPreview(CenterCropToFixedSize).run(Orange.data.Table("iris"))   
