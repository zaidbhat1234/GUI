...
class AdditiveLaplaceNoise(SingleInputWidget):
    name = "AdditiveLaplaceNoise"
    description = ("Computes AdditiveLaplaceNoise")
    icon = "icons/4.svg"
...
if __name__ == "__main__":
    WidgetPreview(AdditiveLaplaceNoise).run(Orange.data.Table("iris"))
