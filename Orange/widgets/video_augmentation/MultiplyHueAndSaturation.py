...
class MultiplyHueAndSaturation(SingleInputWidget):
    name = "MultiplyHueAndSaturation"
    description = ("Computes MultiplyHueAndSaturation")
    icon = "icons/45.svg"
...
if __name__ == "__main__":
    WidgetPreview(MultiplyHueAndSaturation).run(Orange.data.Table("iris"))   
