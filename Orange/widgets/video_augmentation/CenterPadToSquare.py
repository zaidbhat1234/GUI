...
class CenterPadToSquare(SingleInputWidget):
    name = "CenterPadToSquare"
    description = ("Computes CenterPadToSquare")
    icon = "icons/59.svg"
...
if __name__ == "__main__":
    WidgetPreview(CenterPadToSquare).run(Orange.data.Table("iris"))   
