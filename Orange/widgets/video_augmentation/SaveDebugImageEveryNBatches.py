...
class SaveDebugImageEveryNBatches(SingleInputWidget):
    name = "SaveDebugImageEveryNBatches"
    description = ("Computes SaveDebugImageEveryNBatches")
    icon = "icons/63.svg"
...
if __name__ == "__main__":
    WidgetPreview(SaveDebugImageEveryNBatches).run(Orange.data.Table("iris"))   
