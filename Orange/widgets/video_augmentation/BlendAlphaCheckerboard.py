...
class BlendAlphaCheckerboard(SingleInputWidget):
    name = "NMF"
    description = ("Computes BlendAlphaCheckerboard")
    icon = "icons/20.svg"
...
if __name__ == "__main__":
    WidgetPreview(BlendAlphaCheckerboard).run(Orange.data.Table("iris"))   
