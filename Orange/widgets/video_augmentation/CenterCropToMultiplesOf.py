...
class CenterCropToMultiplesOf(SingleInputWidget):
    name = "CenterCropToMultiplesOf"
    description = ("Computes CenterCropToMultiplesOf")
    icon = "icons/57.svg"
...
if __name__ == "__main__":
    WidgetPreview(CenterCropToMultiplesOf).run(Orange.data.Table("iris"))   
