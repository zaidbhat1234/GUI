...
class CenterCropToAspectRatio(SingleInputWidget):
    name = "CenterCropToAspectRatio"
    description = ("Computes CenterCropToAspectRatio")
    icon = "icons/55.svg"
...
if __name__ == "__main__":
    WidgetPreview(CenterCropToAspectRatio).run(Orange.data.Table("iris"))   
