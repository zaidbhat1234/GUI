...
class AllChannelsHistogramEqualization(SingleInputWidget):
    name = "AllChannelsHistogramEqualization"
    description = ("Computes AllChannelsHistogramEqualization")
    icon = "icons/53.svg"
...
if __name__ == "__main__":
    WidgetPreview(AllChannelsHistogramEqualization).run(Orange.data.Table("iris"))   
