...
class BlendAlphaRegularGrid(SingleInputWidget):
    name = "BlendAlphaRegularGrid"
    description = ("Computes BlendAlphaRegularGrid")
    icon = "icons/24.svg"
...
if __name__ == "__main__":
    WidgetPreview(BlendAlphaRegularGrid).run(Orange.data.Table("iris"))   
