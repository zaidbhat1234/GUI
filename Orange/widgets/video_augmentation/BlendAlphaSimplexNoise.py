...
class BlendAlphaSimplexNoise(SingleInputWidget):
    name = "BlendAlphaSimplexNoise"
    description = ("Computes BlendAlphaSimplexNoise")
    icon = "icons/26.svg"
...
if __name__ == "__main__":
    WidgetPreview(BlendAlphaSimplexNoise).run(Orange.data.Table("iris"))   
