...
class RemoveCBAsByOutOfImageFraction(SingleInputWidget):
    name = "RemoveCBAsByOutOfImageFraction"
    description = ("Computes RemoveCBAsByOutOfImageFraction")
    icon = "icons/33.svg"
...
if __name__ == "__main__":
    WidgetPreview(RemoveCBAsByOutOfImageFraction).run(Orange.data.Table("iris"))   
