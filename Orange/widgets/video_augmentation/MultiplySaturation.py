...
class MultiplySaturation(SingleInputWidget):
    name = "MultiplySaturation"
    description = ("Computes MultiplySaturation")
    icon = "icons/47.svg"
...
if __name__ == "__main__":
    WidgetPreview(MultiplySaturation).run(Orange.data.Table("iris"))   
