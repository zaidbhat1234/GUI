...
class FilterEdgeEnhance(SingleInputWidget):
    name = "FilterEdgeEnhance"
    description = ("Computes FilterEdgeEnhance")
    icon = "icons/43.svg"
...
if __name__ == "__main__":
    WidgetPreview(FilterEdgeEnhance).run(Orange.data.Table("iris"))   
