...
class BlendAlphaSegMapClassIds(SingleInputWidget):
    name = "BlendAlphaSegMapClassIds"
    description = ("Computes BlendAlphaSegMapClassIds")
    icon = "icons/25.svg"
...
if __name__ == "__main__":
    WidgetPreview(BlendAlphaSegMapClassIds).run(Orange.data.Table("iris"))   
