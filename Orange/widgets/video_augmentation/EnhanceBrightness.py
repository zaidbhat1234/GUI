...
class EnhanceBrightness(SingleInputWidget):
    name = "EnhanceBrightness"
    description = ("Computes EnhanceBrightness")
    icon = "icons/35.svg"
...
if __name__ == "__main__":
    WidgetPreview(EnhanceBrightness).run(Orange.data.Table("iris"))   
