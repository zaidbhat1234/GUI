...
class KMeansColorQuantization(SingleInputWidget):
    name = "KMeansColorQuantization"
    description = ("Computes KMeansColorQuantization")
    icon = "icons/43.svg"
...
if __name__ == "__main__":
    WidgetPreview(KMeansColorQuantization).run(Orange.data.Table("iris"))   
