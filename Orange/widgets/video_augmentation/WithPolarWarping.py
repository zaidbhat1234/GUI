...
class WithPolarWarping(SingleInputWidget):
    name = "WithPolarWarping"
    description = ("Computes WithPolarWarping")
    icon = "icons/15.svg"
...
if __name__ == "__main__":
    WidgetPreview(WithPolarWarping).run(Orange.data.Table("iris"))   
