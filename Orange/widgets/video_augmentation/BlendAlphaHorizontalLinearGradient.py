...
class BlendAlphaHorizontalLinearGradient(SingleInputWidget):
    name = "BlendAlphaHorizontalLinearGradient"
    description = ("Computes BlendAlphaHorizontalLinearGradient")
    icon = "icons/23.svg"
...
if __name__ == "__main__":
    WidgetPreview(BlendAlphaHorizontalLinearGradient).run(Orange.data.Table("iris"))   
