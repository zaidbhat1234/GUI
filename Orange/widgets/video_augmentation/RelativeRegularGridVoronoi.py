...
class RelativeRegularGridVoronoi(SingleInputWidget):
    name = "RelativeRegularGridVoronoi"
    description = ("Computes RelativeRegularGridVoronoi")
    icon = "icons/52.svg"
...
if __name__ == "__main__":
    WidgetPreview(RelativeRegularGridVoronoi).run(Orange.data.Table("iris"))   
