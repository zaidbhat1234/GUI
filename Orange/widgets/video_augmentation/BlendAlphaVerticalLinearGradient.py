...
class BlendAlphaVerticalLinearGradient(SingleInputWidget):
    name = "BlendAlphaVerticalLinearGradient"
    description = ("Computes BlendAlphaVerticalLinearGradient")
    icon = "icons/28.svg"
...
if __name__ == "__main__":
    WidgetPreview(BlendAlphaVerticalLinearGradient).run(Orange.data.Table("iris"))   
