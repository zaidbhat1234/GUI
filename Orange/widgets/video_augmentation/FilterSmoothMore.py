...
class FilterSmoothMore(SingleInputWidget):
    name = "FilterSmoothMore"
    description = ("Computes FilterSmoothMore")
    icon = "icons/47.svg"
...
if __name__ == "__main__":
    WidgetPreview(FilterSmoothMore).run(Orange.data.Table("iris"))   
