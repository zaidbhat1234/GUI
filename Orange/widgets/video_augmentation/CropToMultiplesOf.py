...
class CropToMultiplesOf(SingleInputWidget):
    name = "CropToMultiplesOf"
    description = ("Computes CropToMultiplesOf")
    icon = "icons/63.svg"
...
if __name__ == "__main__":
    WidgetPreview(CropToMultiplesOf).run(Orange.data.Table("iris"))   
