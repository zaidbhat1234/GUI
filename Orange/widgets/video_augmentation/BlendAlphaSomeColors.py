...
class BlendAlphaSomeColors(SingleInputWidget):
    name = "BlendAlphaSomeColors"
    description = ("Computes BlendAlphaSomeColors")
    icon = "icons/27.svg"
...
if __name__ == "__main__":
    WidgetPreview(BlendAlphaSomeColors).run(Orange.data.Table("iris"))   
