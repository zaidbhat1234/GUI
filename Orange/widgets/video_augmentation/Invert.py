...
from tods.feature_analysis.StatisticalKurtosis import *

class OWInvert(SingleInputWidget):
    name = "Invert"
    description = ("Invert.")
    icon = "icons/Kurtosis.svg"
    ...
    primitive = StatisticalKurtosisPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWInvert).run(Orange.data.Table("iris"))
