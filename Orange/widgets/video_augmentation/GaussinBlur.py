...
from tods.feature_analysis.StatisticalGmean import *

class OWGaussinBlur(SingleInputWidget):
    name = "GaussinBlur"
    description = ("GaussinBlur.")
    icon = "icons/Gmean.svg"
    ...
    primitive = StatisticalGmeanPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWGaussinBlur).run(Orange.data.Table("iris"))
