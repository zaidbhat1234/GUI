...
class ClipCBAsToImagePlanes(SingleInputWidget):
    name = "ClipCBAsToImagePlanes"
    description = ("Computes ClipCBAsToImagePlanes")
    icon = "icons/31.svg"
...
if __name__ == "__main__":
    WidgetPreview(ClipCBAsToImagePlanes).run(Orange.data.Table("iris"))   
