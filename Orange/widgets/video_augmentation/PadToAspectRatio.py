...
class PadToAspectRatio(SingleInputWidget):
    name = "PadToAspectRatio"
    description = ("Computes PadToAspectRatio")
    icon = "icons/66.svg"
...
if __name__ == "__main__":
    WidgetPreview(PadToAspectRatio).run(Orange.data.Table("iris"))   
