...
class MultiplyElementwise(SingleInputWidget):
    name = "MultiplyElementwise"
    description = ("Computes MultiplyElementwise")
    icon = "icons/13.svg"
...
if __name__ == "__main__":
    WidgetPreview(MultiplyElementwise).run(Orange.data.Table("iris"))   
