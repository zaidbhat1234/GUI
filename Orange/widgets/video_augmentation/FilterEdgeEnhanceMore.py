...
class FilterEdgeEnhanceMore(SingleInputWidget):
    name = "FilterEdgeEnhanceMore"
    description = ("Computes FilterEdgeEnhanceMore")
    icon = "icons/42.svg"
...
if __name__ == "__main__":
    WidgetPreview(FilterEdgeEnhanceMore).run(Orange.data.Table("iris"))   
