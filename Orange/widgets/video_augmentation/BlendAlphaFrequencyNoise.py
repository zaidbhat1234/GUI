...
class BlendAlphaFrequencyNoise(SingleInputWidget):
    name = "BlendAlphaFrequencyNoise"
    description = ("Computes BlendAlphaFrequencyNoise")
    icon = "icons/22.svg"
...
if __name__ == "__main__":
    WidgetPreview(BlendAlphaFrequencyNoise).run(Orange.data.Table("iris"))   
