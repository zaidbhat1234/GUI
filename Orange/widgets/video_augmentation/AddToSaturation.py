...
class AddToSaturation(SingleInputWidget):
    name = "AddToSaturation"
    description = ("Computes AddToSaturation")
    icon = "icons/39.svg"
...
if __name__ == "__main__":
    WidgetPreview(AddToSaturation).run(Orange.data.Table("iris"))   
