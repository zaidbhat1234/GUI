...
class CenterCropToPowersOf(SingleInputWidget):
    name = "CenterCropToPowersOf"
    description = ("Computes CenterCropToPowersOf")
    icon = "icons/58.svg"
...
if __name__ == "__main__":
    WidgetPreview(CenterCropToPowersOf).run(Orange.data.Table("iris"))   
