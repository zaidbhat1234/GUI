...
from tods.feature_analysis.StatisticalHmean import *

class OWSaltAndPepper(SingleInputWidget):
    name = "SaltAndPepper"
    description = ("SaltAndPepper.")
    icon = "icons/Hmean.svg"
    ...
    primitive = StatisticalHmeanPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWSaltAndPepper).run(Orange.data.Table("iris"))
