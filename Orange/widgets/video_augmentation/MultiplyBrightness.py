...
class MultiplyBrightness(SingleInputWidget):
    name = "MultiplyBrightness"
    description = ("Computes MultiplyBrightness")
    icon = "icons/44.svg"
...
if __name__ == "__main__":
    WidgetPreview(MultiplyBrightness).run(Orange.data.Table("iris"))   
