...
class PadToMultiplesOf(SingleInputWidget):
    name = "PadToMultiplesOf"
    description = ("Computes PadToMultiplesOf")
    icon = "icons/4.svg"
...
if __name__ == "__main__":
    WidgetPreview(PadToMultiplesOf).run(Orange.data.Table("iris"))   
