...
class BlendAlphaBoundingBoxes(SingleInputWidget):
    name = "BlendAlphaBoundingBoxes"
    description = ("Computes BlendAlphaBoundingBoxes")
    icon = "icons/19.svg"
...
if __name__ == "__main__":
    WidgetPreview(BlendAlphaBoundingBoxes).run(Orange.data.Table("iris"))   
