...
class ChangeColorTemperature(SingleInputWidget):
    name = "ChangeColorTemperature"
    description = ("Computes ChangeColorTemperature")
    icon = "icons/40.svg"
...
if __name__ == "__main__":
    WidgetPreview(ChangeColorTemperature).run(Orange.data.Table("iris"))   
