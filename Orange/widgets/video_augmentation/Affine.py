...
from tods.timeseries_processing.SimpleExponentialSmoothing import *

class OWAffine(SingleInputWidget):
    name = "Affine"
    description = ("Affine")
    ...
    primitive = SimpleExponentialSmoothingPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWAffine).run(Orange.data.Table("iris"))
