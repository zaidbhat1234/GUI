...
class PerpectiveTransform(SingleInputWidget):
    name = "PerpectiveTransform"
    description = ("Computes PerpectiveTransform")
    icon = "icons/5.svg"
...
if __name__ == "__main__":
    WidgetPreview(PerpectiveTransform).run(Orange.data.Table("iris"))   
