...
class EnhanceSharpness(SingleInputWidget):
    name = "EnhanceSharpness"
    description = ("Computes EnhanceSharpness")
    icon = "icons/38.svg"
...
if __name__ == "__main__":
    WidgetPreview(EnhanceSharpness).run(Orange.data.Table("iris"))   
