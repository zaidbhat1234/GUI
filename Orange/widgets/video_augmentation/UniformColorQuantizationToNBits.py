...
class UniformColorQuantizationToNBits(SingleInputWidget):
    name = "UniformColorQuantizationToNBits"
    description = ("Computes UniformColorQuantizationToNBits")
    icon = "icons/50.svg"
...
if __name__ == "__main__":
    WidgetPreview(UniformColorQuantizationToNBits).run(Orange.data.Table("iris"))   
