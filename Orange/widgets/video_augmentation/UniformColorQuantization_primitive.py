...
class UniformColorQuantization_primitive(SingleInputWidget):
    name = "UniformColorQuantization_primitive"
    description = ("Computes UniformColorQuantization_primitive")
    icon = "icons/51.svg"
...
if __name__ == "__main__":
    WidgetPreview(UniformColorQuantization_primitive).run(Orange.data.Table("iris"))   
