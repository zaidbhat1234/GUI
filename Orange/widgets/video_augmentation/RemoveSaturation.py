...
class RemoveSaturation(SingleInputWidget):
    name = "RemoveSaturation"
    description = ("Computes RemoveSaturation")
    icon = "icons/49.svg"
...
if __name__ == "__main__":
    WidgetPreview(RemoveSaturation).run(Orange.data.Table("iris"))   
